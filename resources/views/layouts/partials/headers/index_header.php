<header>
  ...
  <br><br>
  <nav class="main-nav">
    <a href="<?php echo BASE_URL . '/instrumentales/instrumentales_index.php' ?>">Instrumentales</a>
    ...
    <?php if (App\Core\Auth::check()): ?>
      <div class="user-dropdown">
        <a href="#" class="user-dropdown-toggle" id="userDropdownToggle">
          ...
          Hola, <?php echo App\Core\Auth::user()['nombre']; ?>
        </a>
        <div class="dropdown-content" id="userDropdownContent">
          <a href="<?php echo BASE_URL . '/usuarios/profile.php' ?>">Mi Perfil</a>
