<header>
    <a href="<?php echo BASE_URL . '/instrumentales/index.php' ?>" class="titulo-inicio">
        <h1>
            LoopLab
        </h1>
    </a>
    ...
    <nav style="padding: 0px 40px;">
        ...
        <a href="<?php echo BASE_URL . '/carrito/index.php' ?>">
            <svg
        ...
        <?php else: ?>
          <a href="<?php echo BASE_URL . '/auth/login/index.php' ?>">
